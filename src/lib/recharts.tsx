...
export const BarChart: React.FC<any> = ({ children }) => (
  <div className="flex items-end h-full gap-1">{children}</div>
);
export const Bar: React.FC<any> = () => (
  <div className="bg-blue-500 w-full h-1/2"></div>
);
...
export const AreaChart: React.FC<any> = ({ children }) => (
  <div className="flex items-end h-full gap-1">{children}</div>
);
export const Area: React.FC<any> = () => (
  <div className="bg-blue-500 w-full h-1/2"></div>
);
export const ComposedChart: React.FC<any> = ({ children }) => (
  <div className="flex items-end h-full gap-1">{children}</div>
);
