...
export const ArchivePage: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col gap-6 overflow-hidden bg-(--color-zenthar-graphite)/30 p-2 rounded-3xl">
      ...
      <div className="bg-(--color-zenthar-carbon) p-8 rounded-3xl border border-brand-sage/10 shadow-sm relative overflow-hidden group">
        ...
        >
          <div className="flex-1 min-w-200px">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-(--color-zenthar-void) border border-brand-sage/10 rounded-xl pl-12 pr-4 py-3 text-sm focus:ring-2 focus:ring-brand-primary outline-none transition-all text-white"
                value={searchQuery}
          ...
          <div className="w-40">
            ...
            <select
              className="w-full bg-(--color-zenthar-void) border border-brand-sage/10 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-brand-primary text-white"
          ...
          <div className="w-40">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Name..."
                className="w-full bg-(--color-zenthar-void) border border-brand-sage/10 rounded-xl pl-10 pr-4 py-3 text-sm outline-none focus:ring-2 focus:ring-brand-primary text-white"
          ...
          <button
            type="submit"
            className="px-6 py-3 bg-(--color-zenthar-graphite) text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-(--color-zenthar-graphite)/90 transition-all shadow-lg shadow-(--color-zenthar-graphite)/20 border border-brand-sage/10"
          >
            Filter
          </button>
        </form>
      ...
      <div className="flex-1 flex gap-8 overflow-hidden">
            ...
            <button
              ...
              className={`flex items-center gap-4 px-6 py-5 rounded-3xl transition-all duration-300 text-left border relative overflow-hidden group ${
                activeSection === s.id
                  ...
                  : "bg-(--color-zenthar-carbon)/60 backdrop-blur-sm border-brand-sage/20 hover:bg-(--color-zenthar-carbon) hover:border-brand-primary/40 hover:shadow-md hover:scale-[1.01]"
              }`}
            >
              {activeSection === s.id && (
                <motion.div
              ...
              <div
                className={`p-2.5 rounded-2xl transition-all duration-300 shadow-inner ${activeSection === s.id ? "bg-(--color-zenthar-graphite) scale-110" : "bg-(--color-zenthar-void) border border-brand-sage/10 group-hover:scale-105"}`}
              >
                <s.icon
              ...
              <span
                className={`text-sm font-bold tracking-tight transition-colors ${activeSection === s.id ? "text-white" : "text-brand-sage group-hover:text-white"}`}
              >
                {s.label}
              </span>
            </button>
        ...
        {/* Data Table */}
        <div className="flex-1 bg-(--color-zenthar-carbon) rounded-3xl border border-brand-sage/10 overflow-hidden flex flex-col shadow-sm relative group/table">
          ...
          <div className="px-8 py-6 border-b border-brand-sage/10 bg-(--color-zenthar-carbon)/50 backdrop-blur-md flex items-center justify-between relative z-10">
            ...
            <button
              ...
              className="group flex items-center gap-3 px-6 py-3 bg-(--color-zenthar-graphite) text-white rounded-2xl text-xs font-bold uppercase tracking-widest hover:bg-brand-primary transition-all duration-300 shadow-xl shadow-(--color-zenthar-graphite)/20 hover:shadow-brand-primary/30 active:scale-95 overflow-hidden relative border border-brand-sage/10"
            >
                ...
                <tbody className="divide-y divide-brand-sage/5">
                  {data.map((item, idx) => (
                    ...
                    >
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-(--color-zenthar-void) rounded flex items-center justify-center text-[10px] font-mono text-white border border-brand-sage/10">
                            {item.id}
                          </div>
                          <div>
                      ...
                      <td className="p-4 text-right">
                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="p-2 bg-(--color-zenthar-void) text-brand-sage rounded-lg hover:bg-brand-primary hover:text-white transition-all border border-brand-sage/10 hover:border-brand-primary/50"
                            title="View Details"
                          >
      ...
      >
        <div className="space-y-6">
          <div className="flex items-center gap-4 p-4 bg-(--color-zenthar-carbon) rounded-xl border border-brand-primary/10">
          ...
          <div className="bg-(--color-zenthar-void) p-4 rounded-xl border border-brand-sage/20 overflow-x-auto custom-scrollbar">
          ...
          <div className="flex gap-4 pt-4 border-t border-brand-sage/10">
            <button
              ...
              className="flex-1 px-6 py-4 text-[10px] font-black text-brand-sage uppercase tracking-[0.2em] hover:bg-(--color-zenthar-graphite) hover:text-white rounded-2xl transition-all border border-brand-sage/10"
            >
              Close
            </button>
            <button
