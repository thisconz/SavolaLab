        ...
        <div className="grid grid-cols-4 gap-8 shrink-0">
          <div className="bg-(--color-zenthar-carbon) p-8 rounded-3xl border border-brand-sage/10 shadow-sm flex flex-col gap-3 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 text-xs font-bold text-emerald-500 relative z-10">
              ...
              <span className="text-brand-sage font-medium uppercase tracking-wider text-[10px]">
                vs last week
              </span>
            </div>
          </div>
          ...
          <div className="bg-(--color-zenthar-carbon) p-8 rounded-3xl border border-brand-sage/10 shadow-sm flex flex-col gap-3 relative overflow-hidden group">
            ...
            <p className="text-4xl font-black text-white tracking-tighter relative z-10">
              {intelData.metrics.energy}{" "}
              <span className="text-lg font-medium text-brand-sage tracking-normal">
                kWh/t
              </span>
            </p>
        ...
        <div className="grid grid-cols-12 gap-8 shrink-0">
              ...
              <div className="flex flex-col gap-4 p-4">
                {intelData.lines.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    <div className="p-4 bg-(--color-zenthar-void) rounded-full mb-4">
                    ...
                    <p className="text-xs text-brand-sage mt-1">
                      No production lines are currently configured.
                    </p>
                  </div>
                ) : (
          ...
          <div className="col-span-4">
            <LabPanel title="Predictive Maintenance" icon={Activity}>
              <div className="flex flex-col gap-4 p-4">
                <div className="p-5 bg-amber-900/20 border border-amber-500/30 rounded-2xl relative overflow-hidden group">
                  ...
                  <p className="text-sm text-white font-black mb-2 relative z-10">
                    Centrifuge C-101 Vibration
                  </p>
                  <p className="text-xs text-brand-sage font-medium leading-relaxed relative z-10">
                    Vibration levels increasing. Predicted failure in 48 hours
                    if unaddressed.
                  </p>
                </div>
                <div className="p-5 bg-(--color-zenthar-void) border border-brand-sage/20 rounded-2xl relative overflow-hidden group hover:shadow-md transition-all duration-300">
                  ...
                  <div className="flex items-center gap-3 mb-3 relative z-10">
                    <div className="p-2 bg-(--color-zenthar-carbon) rounded-lg shadow-sm border border-brand-sage/10">
                  ...
                  <p className="text-sm text-white font-black mb-2 relative z-10">
                    Evaporator E-202 Cleaning
                  </p>
                  <p className="text-xs text-brand-sage font-medium leading-relaxed relative z-10">
                    Routine CIP scheduled for next shift (15:00).
                  </p>
                </div>
              </div>
            </LabPanel>
