  ...
  if (isSuccess) {
    return (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h2 className="text-xl font-black text-(--color-zenthar-text-primary) uppercase tracking-[0.4em] mb-3">Sync Complete</h2>
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-5 p-4 bg-(--color-zenthar-graphite)/30 rounded-2xl border border-brand-sage/10 relative overflow-hidden group">
          ...
          <div>
            <h2 className="text-[11px] font-black text-(--color-zenthar-text-primary) uppercase tracking-[0.3em]">{steps[currentStepIndex].label} Layer</h2>
            ...
            {step === "otp" && (
              <div className="space-y-6">
                <div className="p-6 bg-(--color-zenthar-void) rounded-4xl border border-brand-sage/10 text-center relative overflow-hidden shadow-2xl">
                   ...
                   <div className="absolute top-0 right-0 p-4 opacity-10"><ShieldAlert className="w-12 h-12 text-(--color-zenthar-text-primary)" /></div>
                </div>
