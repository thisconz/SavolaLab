...
const SAMPLE_TYPE_OPTIONS = [
  "Raw sugar", "White sugar", "Brown sugar", "Polish liquor",
  "Fine liquor", "Evaporator liquor", "Effluent samples",
  "Sweet water", "Utility samples",
];

const SOURCE_STAGE_OPTIONS = [
  "Raw Handling", "Refining", "Carbonation", "Filtration",
  "Evaporation", "Crystallization", "Centrifuge", "Drying", "Packaging",
];
