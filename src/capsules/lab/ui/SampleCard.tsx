        ...
        <div className="p-4 pl-5 relative z-10 flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span
                className={`text-sm font-black tracking-tighter tabular-nums ${active ? "text-brand-deep" : "text-brand-sage"}`}
              >
                #{sample.batch_id}
              </span>
              {isStat && (
          ...
          <div className="flex items-center gap-3">
            <div
              ...
              ${
                active
                  ? isStat
                    ? "bg-lab-laser text-white shadow-lg shadow-lab-laser/20"
            ...
            <div className="flex-1 min-w-0">
              <h4
                className={`text-xs font-bold truncate ${active ? "text-brand-deep" : "text-brand-deep/80"}`}
              >
                {sample.sample_type}
              </h4>
  ...
  return (
    ...
    >
      {isDone ? (
        ...
        <Activity size={8} className="animate-spin-slow" />
      ) : (
        <AlertCircle size={8} />
      )}
      {status}
